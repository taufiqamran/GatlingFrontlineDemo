...
object PayrollBorangPendaftaranPekerjaAsing {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Borang PPA Page")
			.get("/Report/BorangPPAReport")
		...
		.exec(http("request_81")
			.post("/BorangPPAReport/ComboBoxDisplay")
		...
		.exec(http("request_83")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532963259")
			)
		...
		.exec(http("request_85")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=jRsSFuAqcbtlD%2BsE3SfazXgw14xfx94iTyFOz14gYyAvZ4i26iywxXhP9BM9wO0Uvgy3isUqnMBup5l%2B32iycvHfddF135OExpvaV1MrkHTVoyRpzxAUqUmR5FQUJeTqKuNm3ESQ%2FsGE5BGMPxr%2BwK%2FXbgTbmmOwCAP39NiBXd0%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532963260")
			)
		.pause(1)
		...
		.exec(http("request_88")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorangPPAReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._8gdsci&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=125888")
			)
		.pause(1)
		...
		.exec(http("request_90")
			...
			.formParam("CustomSearchParameters[1][Name]", "JoinDateFrom")
			.formParam("CustomSearchParameters[1][Value]", "2021/06/01")
			.formParam("CustomSearchParameters[2][Name]", "JoinDateTo")
			.formParam("CustomSearchParameters[2][Value]", "2021/06/01")
			...
			.formParam("ReportObjectTypeName", "Reports.Statutory.RPT_ST_BORANGPPA"))
		...
		.exec(http("request_92")
			...
			.formParam("arg", "%7B%22reportId%22%3A%2249fecebc14e84996a3f06a8051f777f9%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
		.pause(388.milliseconds)
		.exec(http("request_93")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBuildStatus")
			.formParam("arg", "%7B%22documentId%22%3A%229c78407d53934fc4a3a6dde64cd4364b%22%2C%22timeOut%22%3A120000%7D"))
		...
		.exec(http("request_95")
			...
			.formParam("arg", "9c78407d53934fc4a3a6dde64cd4364b"))
/*		.exec(http("request_96")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=89a2a7cc-77b8-35c9-5154-38f3dab8dcde&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%229c78407d53934fc4a3a6dde64cd4364b%22%2C%22resolution%22%3A96%7D")
			)*/
		.exec(http("request_97")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%229c78407d53934fc4a3a6dde64cd4364b%22%7D"))
