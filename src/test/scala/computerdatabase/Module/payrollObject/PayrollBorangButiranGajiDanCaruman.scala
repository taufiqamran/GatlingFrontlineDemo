...
object PayrollBorangButiranGajiDanCaruman {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication  = {
    exec(http("Kenyataan Butiran dan Caruman")
      .get("/Report/SocsoFormPKSF191Report")
      ...
      .exec(http("request_81")
        .post("/SocsoFormPKSF191Report/ComboBoxDisplay")
      ...
      .exec(http("request_84")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521886467")
      )
      .pause(2)
      .exec(http("request_85")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=BWRkSk4BGb%2FmOnQ4KslPhcRJ%2BWfN59pIQGCSMO2kkMbRyXYccduIVEAskgKswM%2FuGRpzv%2BRKpbYTEA4W%2BGFUxfx4o4uziPY6xKTXoa2ILelr%2FjXu%2BS1OCutffQsvysGqeA30Hz6AjqGuJJ1S9exvNWPvcNTPVLlNJzy4fKbGG0Q%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521886468")
      )
      .pause(1)
      .exec(http("request_86")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FSocsoFormPKSF191Report&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._jau8ps&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=45947")
      )
      .pause(1)
      ...
      .exec(http("request_90")
        ...
        .formParam("CustomSearchParameters[1][Name]", "Location")
        .formParam("CustomSearchParameters[1][Value]", "")
        .formParam("CustomSearchParameters[2][Name]", "LevelRanges")
        .formParam("CustomSearchParameters[2][Value]", "|||||||||")
        .formParam("CustomSearchParameters[3][Name]", "Category")
        .formParam("CustomSearchParameters[3][Value]", "")
        .formParam("CustomSearchParameters[4][Name]", "Grade")
        .formParam("CustomSearchParameters[4][Value]", "")
        .formParam("CustomSearchParameters[5][Name]", "Employee")
        .formParam("CustomSearchParameters[5][Value]", "")
        .formParam("CustomSearchParameters[6][Name]", "HireDateFrom")
        .formParam("CustomSearchParameters[6][Value]", "")
        .formParam("CustomSearchParameters[7][Name]", "HireDateTo")
        .formParam("CustomSearchParameters[7][Value]", "")
        .formParam("CustomSearchParameters[8][Name]", "TerminationDateFrom")
        .formParam("CustomSearchParameters[8][Value]", "")
        .formParam("CustomSearchParameters[9][Name]", "TerminationDateTo")
        .formParam("CustomSearchParameters[9][Value]", "")
        .formParam("CustomSearchParameters[10][Name]", "AccidentDate")
        .formParam("CustomSearchParameters[10][Value]", "2021/06/01")
        .formParam("ReportObjectTypeName", "Reports.Statutory.RPT_SOCSO_PKS_F_191"))
      .pause(180.milliseconds)
      ...
      .exec(http("request_92")
        ...
        .formParam("arg", "%7B%22reportId%22%3A%22ccc290330b3e4b95a34011fabb4b451d%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
      .pause(373.milliseconds)
      .exec(http("request_93")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBuildStatus")
        .formParam("arg", "%7B%22documentId%22%3A%22cd26613b51904e4a9b0bfde063a6aa3a%22%2C%22timeOut%22%3A120000%7D"))
      ...
      .exec(http("request_95")
        ...
        .formParam("arg", "cd26613b51904e4a9b0bfde063a6aa3a"))
      /*		.exec(http("request_96")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=f586b203-2f77-0abb-4217-6e1db84d6386&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22cd26613b51904e4a9b0bfde063a6aa3a%22%2C%22resolution%22%3A96%7D")
            )*/
      .exec(http("request_97")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22cd26613b51904e4a9b0bfde063a6aa3a%22%7D"))
      /*		.exec(http("request_98")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=f586b203-2f77-0abb-4217-6e1db84d6386&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22cd26613b51904e4a9b0bfde063a6aa3a%22%2C%22resolution%22%3A85%7D")
            )*/
      .pause(11)
  }
