  ...
  def loadApplication = {
    exec(http("Transaction Listing Report Page")
      ...
      .exec(http("request_102")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622450821894")
      )
      .pause(703.milliseconds)
      .exec(http("request_103")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FTransactionListingReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._wylf92&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=8601")
      )
      .exec(http("request_104")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=lNeU%2F3RRJvqK2zK8eaSN80m5kF82Ti2Tr3jVOJppz5ezel%2BQLtvTULQRXQeHc8XMUxGHioezF4SLw2ja8%2BY3t%2BW4c6OuGvCkmQDTbCG5mz%2FBREQOPVHLZ0kIJhMTH9jmXKnrBUXu6dGXywIiWJ%2B0KG4k3X3nWqkHi07sjeG%2BhEY%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622450821895")
      )
      .pause(4)
      ...
      .exec(http("request_113")
        ...
        .formParam("arg", "ea074d0d13a74c0c95a8f892b40148bb"))
      /*		.exec(http("request_114")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=d0f9c85e-5f7c-345e-0de9-5cc932cafdbb&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ea074d0d13a74c0c95a8f892b40148bb%22%2C%22resolution%22%3A96%7D")
            )*/
      .exec(http("request_115")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ea074d0d13a74c0c95a8f892b40148bb%22%7D"))
      /*		.exec(http("request_116")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=d0f9c85e-5f7c-345e-0de9-5cc932cafdbb&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ea074d0d13a74c0c95a8f892b40148bb%22%2C%22resolution%22%3A43%7D")
            )*/
      .pause(12)
  }
