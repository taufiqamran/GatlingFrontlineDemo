  ...
  def loadApplication = {
    exec(http("Transaction Detail Summary Report Page")
      ...
      .exec(http("request_81")
        .post("/TransactionDetailSummaryReport/ComboBoxDisplay")
      ...
      .exec(http("request_83")
        .post("/TransactionDetailSummaryReport/ComboBoxTextDisplay")
      ...
      .exec(http("request_87")
        .post("/TransactionDetailSummaryReport/GetCascadeChildDropdown")
      ...
      .exec(http("request_89")
        .post("/TransactionDetailSummaryReport/CascadeComboBoxDisplay")
      ...
      .exec(http("request_93")
        .post("/TransactionDetailSummaryReport/CheckBoxListDisplay")
      ...
      .exec(http("request_100")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622451075003")
      )
      ...
      .exec(http("request_102")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FTransactionDetailSummaryReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._5d26yl&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=122650")
      )
      .pause(620.milliseconds)
      .exec(http("request_103")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=EsPwpQmRXZf%2Fik%2BufIrLuh3udUW%2BO98CGnqtC3jioRyd7NjwKZPMC73iILScD4BepoZNN9N%2FLGak28J%2FPjGKvmepSXHBatNf%2FoKZ%2BHnuCJAGZGyjiHUV2JapUO8cHOKHqFiyEvZp99FD8mXzpj0VMuQAnto3hRq5PmR0iuNGIOA%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622451075004")
      )
      .pause(2)
      ...
      .exec(http("request_107")
        .post("/Report/GenerateTransactionDetailSummaryReport")
        ...
        .formParam("CustomSearchParameters[17][Name]", "TerminationDateTo")
        .formParam("CustomSearchParameters[17][Value]", "")
        .formParam("ReportObjectTypeName", "Reports.Payroll.RPT_PAY_TRANSACTIONDETAILSUMMARY"))
      ...
      /*		.exec(http("request_112")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=9b6514ea-4d5f-a3e7-4f0e-272b97978544&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%221c85a93d68934a43b2cd1785f1e312f1%22%2C%22resolution%22%3A96%7D")
            )*/
      .exec(http("request_113")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%221c85a93d68934a43b2cd1785f1e312f1%22%7D"))
      /*		.exec(http("request_114")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=9b6514ea-4d5f-a3e7-4f0e-272b97978544&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%221c85a93d68934a43b2cd1785f1e312f1%22%2C%22resolution%22%3A52%7D")
            )*/
      ...
      .exec(http("request_116")
        ...
        .formParam("arg", "1c85a93d68934a43b2cd1785f1e312f1"))
      /*		.exec(http("request_117")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=6ecc040d-bae6-cd65-7060-1e5fa146b4bf&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%221c85a93d68934a43b2cd1785f1e312f1%22%2C%22resolution%22%3A52%7D")
            )*/
