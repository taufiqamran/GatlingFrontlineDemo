  ...
  def loadApplication = {
    exec(http("Borang 2 Page")
		...
		.exec(http("request_81")
			...
			.post("/Borang2Report/ComboBoxDisplay")
		...
		.exec(http("request_83")
			.post("/Borang2Report/ComboBoxTextDisplay")
		...
		.exec(http("request_85")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532155504")
			)
	...
	.exec(http("request_89")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=5HULl0F7kfpnLWhADZsoLd%2FBnSu4ipIhhenigZQK3kg8AEjzNS3Ny79Uiu9mN4c5n2WhE7Yu%2FSur3yI9t2%2BbGCpuwYOYGkx9VkCtvNmvzo%2F5oJ%2FDhUlkpztiiKIm1WKNN51USKpk%2FUKBU%2Fqx2kD7PuZObtaO58x9g5dDGyjg%2FeU%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532155505")
			)
		.pause(1)
		.exec(http("request_90")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorang2Report&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._8x5k7o&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=22312")
			)
		...
		.exec(http("request_92")
			...
			.formParam("ReportObjectTypeName", "Reports.Statutory.Borang2Report"))
		...
		.exec(http("request_94")
			...
			.formParam("arg", "%7B%22reportId%22%3A%22ff37ed5f460a48a2b8cbed6a316df69c%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
		.pause(386.milliseconds)
		.exec(http("request_95")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBuildStatus")
			.formParam("arg", "%7B%22documentId%22%3A%22ad8685b34acb445487f3afad6bc9a335%22%2C%22timeOut%22%3A120000%7D"))
		.exec(http("request_96")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getDocumentData")
			.formParam("arg", "ad8685b34acb445487f3afad6bc9a335"))
	/*	.exec(http("request_97")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=118b9400-1840-93ac-dd61-245e4cd527e8&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ad8685b34acb445487f3afad6bc9a335%22%2C%22resolution%22%3A96%7D"))
		*/
			.exec(http("request_98")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ad8685b34acb445487f3afad6bc9a335%22%7D"))
/*		.exec(http("request_99")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=118b9400-1840-93ac-dd61-245e4cd527e8&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22ad8685b34acb445487f3afad6bc9a335%22%2C%22resolution%22%3A73%7D")
			)*/
