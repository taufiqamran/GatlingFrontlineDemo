...
object PayrollBorangLampiran1Arrears {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Arrears Report")
      .get("/Report/EISArrearsReport")
      ...
      .exec(http("request_83")
        .post("/EISArrearsReport/ComboBoxTextDisplay")
      ...
      .exec(http("request_85")
        ...
        .formParam("objectLabel", "ArrearsMonth")
        .formParam("comboBoxValue", "")
        .formParam("textBoxValue", "2021"))
      ...
      .exec(http("request_87")
        .post("/EISArrearsReport/CheckBoxListDisplay")
      ...
      .exec(http("request_89")
        .post("/EISArrearsReport/ComboBoxDisplay")
      ...
      .exec(http("request_91")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622533112715")
      )
      .pause(1)
      .exec(http("request_92")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=ujA%2FGY5iNLK%2BUDlU5DZ%2FsfraLuJ5g0T8JuqArq%2B7a%2BkmTp1FwMt9XultbIMTinYlsc0DZvxmBJ6h3ItxW%2F%2BOxruQfjKGl2DrmFnEhwoVqa3%2F5M9EsYaVqO3NbD91ZQt8SEQksZpnsi0Z9ovl3PXUkW6j6iPk7N03ruzQ%2BOI8ip0%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622533112716")
      )
      ...
      .exec(http("request_95")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FEISArrearsReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._yzf38z&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=24775")
      )
      ...
      .exec(http("request_101")
        ...
        .formParam("CustomSearchParameters[3][Name]", "ArrearsMonth")
        .formParam("CustomSearchParameters[3][Value]", "5")
        .formParam("CustomSearchParameters[4][Name]", "ArrearsMonthTextBox")
        ...
        .formParam("ReportObjectTypeName", "Reports.Payroll.RPT_PAY_EISARREARS"))
      ...
      .exec(http("request_103")
        ...
        .formParam("arg", "%7B%22reportId%22%3A%222bf1899dae814790b460e5804e289235%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
      .pause(465.milliseconds)
      .exec(http("request_104")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBuildStatus")
        .formParam("arg", "%7B%22documentId%22%3A%2201435300326d43188361cacc7bfe5ab3%22%2C%22timeOut%22%3A120000%7D"))
      ...
      .exec(http("request_106")
        ...
        .formParam("arg", "01435300326d43188361cacc7bfe5ab3"))

      .exec(http("request_108")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%2201435300326d43188361cacc7bfe5ab3%22%7D"))
      /*.exec(http("request_109")
        .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=61fbed4d-f7fd-c97e-12b9-cfd8c2283e86&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%2201435300326d43188361cacc7bfe5ab3%22%2C%22resolution%22%3A85%7D")
        )*/
      .pause(13)
