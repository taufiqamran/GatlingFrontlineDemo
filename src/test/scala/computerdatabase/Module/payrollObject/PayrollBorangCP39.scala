  ...
  def loadApplication = {
    exec(http("Borang CP39 Page")
		...
		.exec(http("request_81")
			.post("/BorangCP39Report/ComboBoxDisplay")
		...
		.exec(http("request_85")
			.post("/BorangCP39Report/CascadeComboBoxDisplay")
		...
		.exec(http("request_87")
			.post("/BorangCP39Report/CheckBoxListDisplay")
		...
		.exec(http("request_90")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521511980")
			)
		.pause(488.milliseconds)
	.exec(http("request_91")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=hrAvl%2FSfZXRVsrynjnfo8H3mTU97IogC7Mvc0S6Ju7q5mQnYsTcFIfm6XnP1gpTz7pGK2YGDoAkIADsveuo68dzNqfcfZR6ej5p3yTW873xGVPVjc56FJyNZtVHJ5aEYsZw%2BAc%2FLWXDHRlAAO%2BW9dbb2n8QDAGhNr8vdWb73xIc%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521511981")
			)
		...
		.exec(http("request_95")
			.post("/BorangCP39Report/GetCascadeChildDropdown")
		...
		.exec(http("request_98")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorangCp39Report&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._nn16si&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=35509")
			)
		...
		.exec(http("request_106")
			.post("/Report/GenerateBorangCP39Report")
			...
			.formParam("CustomSearchParameters[16][Name]", "ChequeNo")
			.formParam("CustomSearchParameters[16][Value]", "")
			.formParam("ReportObjectTypeName", "Reports.Statutory.BorangCP39Report"))
		...
		.exec(http("request_108")
			...
			.formParam("arg", "%7B%22reportId%22%3A%22201e9551147249e3a9ecf0f682d5ef3e%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%7B%22Value%22%3A%222021-06-01T00%3A00%3A00.000Z%22%2C%22Key%22%3A%22PayDate%22%2C%22TypeString%22%3A%22System.DateTime%22%7D%5D%7D"))
		.pause(361.milliseconds)
		.exec(http("request_109")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBuildStatus")
			.formParam("arg", "%7B%22documentId%22%3A%223183e312a7954f0f9ebfe692a380ca61%22%2C%22timeOut%22%3A120000%7D"))
		...
		.exec(http("request_111")
			...
			.formParam("arg", "3183e312a7954f0f9ebfe692a380ca61"))

/*	.exec(http("request_112")
		.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=b45b64e7-6258-17bd-04cc-930bd500f523&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%223183e312a7954f0f9ebfe692a380ca61%22%2C%22resolution%22%3A96%7D")
		)*/
		...
		.exec(http("request_113")
			...
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%223183e312a7954f0f9ebfe692a380ca61%22%7D"))
