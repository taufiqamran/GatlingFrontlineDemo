...
object PayrollSalaryPayoutReport {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Salary Payout Page")
			.get("/Report/SalaryPayoutReport")
		...
		.exec(http("request_83")
			.post("/SalaryPayoutReport/ComboBoxTextDisplay")
		...
		.exec(http("request_85")
			.post("/SalaryPayoutReport/GetCascadeChildDropdown")
		...
		.exec(http("request_86")
			.post("/SalaryPayoutReport/ComboBoxDisplay")
		...
		.exec(http("request_90")
			.post("/SalaryPayoutReport/CheckBoxListDisplay")
		...
		.exec(http("request_95")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518091823")
			)
		.exec(http("request_96")
			.post("/SalaryPayoutReport/CascadeComboBoxDisplay")
		...
		.exec(http("request_99")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=E2M%2B6xap%2BVO3QPzRllVScTdjZ2r67JJBsVI4z8T1Oo8ummt7o9ot3W%2BGo8Ve6BkDtdUzVfKYfvz1tEIo4uY7s18%2F58aveam8r4BKN0ZfX0wlY%2BoLBWORGOvaGeXTZEdZ5mkTOgr5gioMy5p9gEIT8UGq9by0Jx5JARPVXMl1ZRQ%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518091824")
			)
		.pause(2)
		.exec(http("request_100")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FSalaryPayoutReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._hn1rzp&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=59303")
			)
		.pause(6)
		...
		.exec(http("request_102")
			...
			.formParam("objectLabel", "GroupBy")
			.formParam("comboBoxValue", "1"))
		.pause(974.milliseconds)
		.exec(http("request_103")
			.post("/Account/VerifyAccess")
			)
		.exec(http("request_104")
			.post("/Report/SalaryPayoutGroupingReportGenerate")
			...
			.formParam("CustomSearchParameters[16][Name]", "TerminationDateTo")
			.formParam("CustomSearchParameters[16][Value]", "")
			.formParam("ReportObjectTypeName", "Reports.Payroll.SalaryPayoutReportGrouping"))
		...
		.exec(http("request_109")
			...
			.formParam("arg", "f59695ba7bbd4f93afbe6919959e5b79"))
/*		.exec(http("request_110")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=a0047aac-1142-3c14-f952-546a592258aa&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22f59695ba7bbd4f93afbe6919959e5b79%22%2C%22resolution%22%3A96%7D")
			)*/
		.exec(http("request_111")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22f59695ba7bbd4f93afbe6919959e5b79%22%7D"))
/*		.exec(http("request_112")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=a0047aac-1142-3c14-f952-546a592258aa&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22f59695ba7bbd4f93afbe6919959e5b79%22%2C%22resolution%22%3A73%7D")
			)*/
		.pause(8)
  }
