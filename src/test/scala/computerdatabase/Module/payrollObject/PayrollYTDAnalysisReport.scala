  ...
  def loadApplication = {
    exec(http("Payroll YTD Analysis Report")
		...
		.exec(http("request_86")
			.post("/PayrollYTDAnalysisReport/GetCascadeChildDropdown")
			...
			.formParam("CustomSearchParameters[0][Value]", "T")
			...
			.formParam("CustomSearchParameters[6][Name]", "DisplayLine")
		...
		.exec(http("request_89")
			...
			.formParam("objectLabel", "DisplayLine")
		...
		.exec(http("request_93")
			.post("/PayrollYTDAnalysisReport/CascadeComboBoxDisplay")
		...
		.exec(http("request_96")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518673354")
			)
		.pause(1)
		.exec(http("request_97")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=OFfQ4U2hcgVGF5YvvxrZT4CpltNfSCU7m2b2OCXckZ5IxUtATAGXua8KDkfWU75Q%2B3Z1dR726pm%2FJ7guv98LMiLJEQTbcOs47fmyUCS%2FNjQDdscBzqDUGd60DJ4e6bfE%2BDYKIExWD%2FooVdgtSqcCTL8NBOgF19ES44fsTl%2BTtfE%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518673355")
			)
		...
		.exec(http("request_99")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FPayrollYTDAnalysisReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._rdrkgf&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=20974")
			)
		.exec(http("request_100")
			.post("/Report/GeneratePayrollYTDAnalysisReport")
			...
			.formParam("CustomSearchParameters[6][Name]", "DisplayLine")
			.formParam("CustomSearchParameters[6][Value]", "0")
			.formParam("CustomSearchParameters[7][Name]", "Location")
			.formParam("CustomSearchParameters[7][Value]", "")
			.formParam("CustomSearchParameters[8][Name]", "LevelRanges")
			.formParam("CustomSearchParameters[8][Value]", "|||||||||")
			...
			.formParam("CustomSearchParameters[15][Name]", "TerminationDateTo")
			.formParam("CustomSearchParameters[15][Value]", "")
			.formParam("ReportObjectTypeName", "Reports.Payroll.RPT_PAY_YTDANALYSISBYENTITY"))
		...
		.exec(http("request_102")
			...
			.formParam("arg", "%7B%22documentId%22%3A%22df4e71ec85d0445eb3ee24bdf33e68cf%22%2C%22timeOut%22%3A120000%7D"))
		.exec(http("request_103")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getDocumentData")
			.formParam("arg", "df4e71ec85d0445eb3ee24bdf33e68cf"))
		.exec(http("request_104")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=f8a7aafb-51cd-7932-acde-9014d28bf075&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22df4e71ec85d0445eb3ee24bdf33e68cf%22%2C%22resolution%22%3A96%7D")
			)
		.exec(http("request_105")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22df4e71ec85d0445eb3ee24bdf33e68cf%22%7D"))
		.exec(http("request_106")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=f8a7aafb-51cd-7932-acde-9014d28bf075&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22df4e71ec85d0445eb3ee24bdf33e68cf%22%2C%22resolution%22%3A66%7D")
			)
		.pause(13)
  }
