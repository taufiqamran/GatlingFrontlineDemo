  ...
  def loadApplication = {
    exec(http("Borang CP22 Page")
		...
		.exec(http("request_81")
			.post("/BorangCP22Report/ComboBoxTextDisplay")
		...
		.exec(http("request_84")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532361160")
			)
		.exec(http("request_85")
			.post("/BorangCP22Report/ComboBoxDisplay")
			
			.formParam("objectLabel", "EMPLOYER_AGENCY_ID")
			.formParam("comboBoxValue", ""))
		.pause(1)
		.exec(http("request_86")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=EXaRUQPLpT1TeThundphcx4lb7DHJ4K7QaDwQb%2FdODYvhOdM4kb1N2kjbL84YCXfxtGqroI5H%2FqjVpUebnV1nkD24DYuiyyrNPfacpKGmmghu9aeAzKdlCZ9KIw%2FkbPQBVAdFtAcXFf%2Bu1AHkwNuh7%2BQvvD80AmvD3n9F%2Ft98%2BU%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532361161")
			)
		.pause(2)
		.exec(http("request_87")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorangCP22&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._3uoch6&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=111978")
			)
		.pause(593.milliseconds)
		...
		.exec(http("request_91")
			.post("/Report/GenerateBorangCP22Report")
			...
			.formParam("ReportObjectTypeName", "Reports.Statutory.RPT_BORANG_CP22"))
		...
		.exec(http("request_96")
			...
			.formParam("arg", "de580cdc75c74a78baa1e6d9872b8fe9"))
/*		.exec(http("request_97")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=739d6f5d-7c8a-45b7-dc0f-13c7e914fe19&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22de580cdc75c74a78baa1e6d9872b8fe9%22%2C%22resolution%22%3A96%7D")
			)*/
		.exec(http("request_98")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22de580cdc75c74a78baa1e6d9872b8fe9%22%7D"))
		.pause(11)
