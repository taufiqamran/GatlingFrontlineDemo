...
object PayrollTransactionAnalysisReport {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Transaction Analysis Report")
			.get("/Report/TransactionAnalysisReport")
		...
		.exec(http("request_81")
			.post("/TransactionAnalysisReport/CheckBoxListDisplay")
		...
		.exec(http("request_85")
			.post("/TransactionAnalysisReport/GetCascadeChildDropdown")
			...
			.formParam("CustomSearchParameters[17][Name]", "Transaction")
		...
		.exec(http("request_86")
			.post("/TransactionAnalysisReport/ComboBoxTextDisplay")
		...
		.exec(http("request_93")
			.post("/TransactionAnalysisReport/CascadeComboBoxDisplay")
		...
		.exec(http("request_101")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518877979")
			)
		.exec(http("request_102")
			.post("/TransactionAnalysisReport/ComboBoxDisplay")
			
			.formParam("objectLabel", "GroupBy")
			.formParam("comboBoxValue", ""))
		.pause(2)
		.exec(http("request_103")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FTransactionAnalysisReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._h2nrk8&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=90701")
			)
		.exec(http("request_104")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=snLUrs0SAUvJUNEz05GeR08GP0Ne9a2b3Cec3b9dpbhdjYKfsrgIrPnT5xYzJxm6I7n3P8IWNBQNSHowwQmenDaczw%2BLn9954nkGJwLRWfn8ImJBerB6cmpi%2BUjAYsXpZ4b0GKF%2FNR9Mw7U3Kg8fy2Br0TdgtL4AtinakXRBHn4%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518877980")
			)
		.pause(6)
		...
		.pause(899.milliseconds)
		.exec(http("request_107")
			.post("/Account/VerifyAccess")
			)
		.exec(http("request_108")
			.post("/Report/GenerateTransactionAnalysisReport")
			...
			.formParam("CustomSearchParameters[18][Name]", "ShowQty")
			.formParam("CustomSearchParameters[18][Value]", "")
			.formParam("ReportObjectTypeName", "Reports.Payroll.RPT_PAY_TRANSACTIONANALYSISBYENTITY"))
		...
		.exec(http("request_110")
			...
			.formParam("arg", "%7B%22documentId%22%3A%22a5ee66a9e8064a159228d0bac57d5040%22%2C%22timeOut%22%3A120000%7D"))
		.exec(http("request_111")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getDocumentData")
			.formParam("arg", "a5ee66a9e8064a159228d0bac57d5040"))
/*		.exec(http("request_112")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=7751130a-ba18-31f0-2ede-922d1f1a0678&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22a5ee66a9e8064a159228d0bac57d5040%22%2C%22resolution%22%3A96%7D")
			)*/
		.exec(http("request_113")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22a5ee66a9e8064a159228d0bac57d5040%22%7D"))
/*		.exec(http("request_114")
			.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=7751130a-ba18-31f0-2ede-922d1f1a0678&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22a5ee66a9e8064a159228d0bac57d5040%22%2C%22resolution%22%3A51%7D")
			)*/
		.pause(6)
  }
