  ...
  def loadApplication = {
    exec(http("Payroll Transaction")
      ...
      .exec(http("request_111")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623468334666")
      )
      .pause(1)
      .exec(http("request_112")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=uX%2FjpYUt9vag9HPhK3nCW%2BPyeGAnnNigESs8RmaSq6P4F%2F30QZI9FoKAdKuxKp4vzar%2B0qSkk71SpmwvUyMGeQOzwztrQZ0nJFHa0%2FTgNTzDBoXpgQazEMFBUOB5I%2B97bZp8Jv6KYwhEMEqGjrjsw5ctcUOsr8ceROCci%2FA3V%2BI%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1623468334667")
      )
      .pause(533.milliseconds)
  }
