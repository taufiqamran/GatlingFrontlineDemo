  ...
  def loadApplication = {
    exec(http("Borang CP22A Page")
		...
		.exec(http("request_80")
			.post("/BorangCP22AReport/ComboBoxDisplay")
		...
		.exec(http("request_82")
			.post("/BorangCP22AReport/ComboBoxTextDisplay")
		...
		.exec(http("request_87")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532517945")
			)
		.pause(184.milliseconds)
		.exec(http("request_88")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=Nd9EN87tkNJC4pAjuGcrSnsaiKE5VOb0oxIm709Sfn7PF1L65YbrgRvhoj%2BwMpKVNHBh2%2FK5RXeBErCclnu8zmI7jlaGkqF35jSdiBcQyOAZB9xw5O3FRV3OPh46qA9Ns3HD9iuF%2BKynaZA2WEjzaUG8SgqlclDbMF7YHuiT4xs%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532517946")
			)
		.pause(862.milliseconds)
		...
		.exec(http("request_91")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorangCP22AReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._ky3lhe&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=52867")
			)
		...
		.exec(http("request_93")
			...
			.formParam("ReportObjectTypeName", "Reports.Statutory.RPT_ST_BORANGCP22A"))
		...
		.exec(http("request_95")
			...
			.formParam("arg", "%7B%22reportId%22%3A%22e224bc82d63341d3acf9a1d1a7c95a5d%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
		.pause(266.milliseconds)
		.exec(http("request_96")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBuildStatus")
			.formParam("arg", "%7B%22documentId%22%3A%229d5eb5f482e44a10836c1fba8f00f153%22%2C%22timeOut%22%3A120000%7D"))
		...
		.exec(http("request_98")
			...
			.formParam("arg", "9d5eb5f482e44a10836c1fba8f00f153"))

/*	.exec(http("request_99")
		.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=b737c189-eaa8-138d-4d73-5e3dd2018799&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%229d5eb5f482e44a10836c1fba8f00f153%22%2C%22resolution%22%3A96%7D")
		)*/
		...
		.exec(http("request_100")
			...
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%229d5eb5f482e44a10836c1fba8f00f153%22%7D"))
		.pause(12)
