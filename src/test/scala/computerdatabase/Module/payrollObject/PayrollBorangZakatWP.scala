...
object PayrollBorangZakatWP {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Borang Zakat WP Page")
      .get("/Report/ZakatWilayahPersekutuanReport")
      ...
      .exec(http("request_83")
        .post("/ZakatWilayahPersekutuanReport/ComboBoxDisplay")
      ...
      .exec(http("request_87")
        .post("/ZakatWilayahPersekutuanReport/CheckBoxListDisplay")

        .formParam("objectLabel", "ZakatClassification")
        .formParam("objectSelectedIds[]", "P"))
      ...
      .exec(http("request_91")
        .post("/ZakatWilayahPersekutuanReport/CascadeComboBoxDisplay")
      ...
      .exec(http("request_98")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521596504")
      )
      .pause(479.milliseconds)
      .exec(http("request_99")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=imoq7qSf%2Fn8CZPKrb5uUUh1oUS%2F2aTkg8qg2ukc%2FXfV2OfXt%2FvkkecZXflckeiezXOYzleexECpwSsk6TCefAnEyn%2FNaz%2Bau2w2LN%2BUUbsotw6ZSubEE3F1xF8IoRyug4x5NwmnF4bl9%2FuykX3DfKh6FoveYUEoDqVaI11ZOYyE%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622521596505")
      )
      .pause(878.milliseconds)
      .exec(http("request_100")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FZakatWilayahPersekutuanReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._koqqcy&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=74160")
      )
      .pause(898.milliseconds)
      ...
      .exec(http("request_102")
        ...
        .formParam("objectLabel", "EMPLOYER_AGENCY_ID")
        .formParam("comboBoxValue", "103"))
      .exec(http("request_103")
        .post("/Account/VerifyAccess")
      )
      .exec(http("request_104")
        .post("/ZakatWilayahPersekutuanReport/GetCascadeChildDropdown")
        ...
        .formParam("CustomSearchParameters[0][Value]", "103")
        .formParam("CustomSearchParameters[1][Name]", "ZakatState")
        .formParam("CustomSearchParameters[1][Value]", "")
        .formParam("CustomSearchParameters[2][Name]", "ZakatClassification")
        .formParam("CustomSearchParameters[2][Value]", "P")
        .formParam("CustomSearchParameters[3][Name]", "PayrollYear")
        .formParam("CustomSearchParameters[3][Value]", "2021")
        .formParam("CustomSearchParameters[4][Name]", "PayMonths")
      ...
      .exec(http("request_112")
        ...
        .formParam("CustomSearchParameters[5][Name]", "PayPeriod")
        .formParam("CustomSearchParameters[5][Value]", "82,420,758,759,760,761,762,763,764,765,766,767,768")
        .formParam("CustomSearchParameters[6][Name]", "EmployeeStatus")
        .formParam("CustomSearchParameters[6][Value]", "A,L,I")
        .formParam("CustomSearchParameters[7][Name]", "Location")
        .formParam("CustomSearchParameters[7][Value]", "")
      ...
      .exec(http("request_118")
        ...
        .formParam("CustomSearchParameters[3][Value]", "2021")
        .formParam("CustomSearchParameters[4][Name]", "PayMonths")
        .formParam("CustomSearchParameters[4][Value]", "5")
        .formParam("CustomSearchParameters[5][Name]", "PayPeriod")
        .formParam("CustomSearchParameters[5][Value]", "82,420")
        .formParam("CustomSearchParameters[6][Name]", "EmployeeStatus")
        .formParam("CustomSearchParameters[6][Value]", "A,L,I")
        .formParam("CustomSearchParameters[7][Name]", "Location")
        .formParam("CustomSearchParameters[7][Value]", "")
      ...
      .exec(http("request_122")
        ...
        .formParam("CustomSearchParameters[4][Value]", "5")
        .formParam("CustomSearchParameters[5][Name]", "PayPeriod")
        .formParam("CustomSearchParameters[5][Value]", "761")
        .formParam("CustomSearchParameters[6][Name]", "EmployeeStatus")
        .formParam("CustomSearchParameters[6][Value]", "A,L,I")
        .formParam("CustomSearchParameters[7][Name]", "Location")
        .formParam("CustomSearchParameters[7][Value]", "")
        ...
        .formParam("CustomSearchParameters[17][Name]", "CompanyAccount")
        .formParam("CustomSearchParameters[17][Value]", "")
        .formParam("ReportObjectTypeName", "Reports.Zakat.ZakatWilayahPersekutuanReport"))
      ...
      .exec(http("request_124")
        ...
        .formParam("arg", "%7B%22reportId%22%3A%222470ce0442424f30b9d3d294b3e146d5%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
      .pause(368.milliseconds)
      .exec(http("request_125")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBuildStatus")
        .formParam("arg", "%7B%22documentId%22%3A%22f7345a31c2234fcbb6f5447e5b89af20%22%2C%22timeOut%22%3A120000%7D"))
      ...
      .exec(http("request_127")
        ...
        .formParam("arg", "f7345a31c2234fcbb6f5447e5b89af20"))

      .exec(http("request_129")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22f7345a31c2234fcbb6f5447e5b89af20%22%7D"))
      /*		.exec(http("request_130")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=37f9a30d-002e-5f95-0b1b-cb58b13fac5e&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%22f7345a31c2234fcbb6f5447e5b89af20%22%2C%22resolution%22%3A85%7D")
            )*/
      .pause(11)
  }
