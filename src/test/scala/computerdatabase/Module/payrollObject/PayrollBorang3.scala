  ...
  def loadApplication = {
    exec(http("Borang 3 Page")
		...
		.exec(http("request_81")
			.post("/Borang3Report/ComboBoxDisplay")
		...
		.exec(http("request_83")
			.post("/Borang3Report/ComboBoxTextDisplay")
			
			.formParam("objectLabel", "ResignedMonthYear")
		...
		.exec(http("request_86")
			.get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532277883")
			)
		.pause(2)
		...
		.exec(http("request_89")
			.get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=N2ZeJKPFOOo2HNhBlY%2BnVKn%2FtqewigKV4oBQ9Gahe1Gjumf%2FN%2FIfRw4KcyAuFXmDdvV%2Fb2tkyd38CP2LfvV5EUerIxCH%2BjEccEsDSxeKl7%2BXxp99VEyA0gjrFp%2FZzDEDFYd9h9jlb3RxafQKBsL59akVHqcg1yqbpESFhgDSErY%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622532277884")
			)
		.pause(505.milliseconds)
		.exec(http("request_90")
			.get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorang3&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._qnecih&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=101534")
			)
		.pause(1)
		...
		.exec(http("request_92")
			.post("/Report/GenerateBorang3Report")
			...
			.formParam("CustomSearchParameters[8][Name]", "PrintDate")
			.formParam("CustomSearchParameters[8][Value]", "2021/06/01")
			.formParam("ReportObjectTypeName", "Reports.Statutory.RPT_BORANG_3"))
		...
		.exec(http("request_97")
			...
			.formParam("arg", "4d8a3660378343d39656d67a92b76d6b"))
/*	.exec(http("request_98")
		.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=fbd11672-d452-0d0e-1b50-5048308c2c80&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%224d8a3660378343d39656d67a92b76d6b%22%2C%22resolution%22%3A96%7D")
		)*/
		.exec(http("request_99")
			.post("/Report/DXXRDV.axd")
			
			.formParam("actionKey", "getBrickMap")
			.formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%224d8a3660378343d39656d67a92b76d6b%22%7D"))

/*	.exec(http("request_100")
		.get("/Report/DXXRDV.axd?actionKey=getPage&unifier=fbd11672-d452-0d0e-1b50-5048308c2c80&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%224d8a3660378343d39656d67a92b76d6b%22%2C%22resolution%22%3A73%7D")
		)*/
