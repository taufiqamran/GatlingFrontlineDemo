...
object PayrollEpfSocsoPayReport {

  val uri1 = "https://maps.googleapis.com/maps/api/js"
  val uri3 = "https://fonts.googleapis.com/css"

  def loadApplication = {
    exec(http("Epf Socso Pay Report")
      .get("/Report/EpfSocsoPayReport")
      ...
      .exec(http("request_84")
        .post("/EPFSocsoPayReport/ComboBoxTextDisplay")

        .formParam("objectLabel", "PayrollMonth")
        .formParam("comboBoxValue", "7")
        .formParam("textBoxValue", "2021"))
      .exec(http("request_85")
        .post("/EPFSocsoPayReport/RadioButtonListDisplay")

        .formParam("objectLabel", "ReportType")
        .formParam("radioButtonValue", "C"))
      .exec(http("request_86")
        .post("/Account/VerifyAccess")
      )
      .exec(http("request_87")
        .post("/EPFSocsoPayReport/CheckBoxListDisplay")
      ...
      .exec(http("request_90")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518389569")
      )
      .pause(1)
      .exec(http("request_91")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=X29d2yT5pQixXEj6EhB%2F3aMmuMId7axSsKV4w3GzLx7xk8mHzJKedzPXKbUXded6Pfp1tB%2BzgRypiyu%2FkzUTkKqZeoxH3Ry3CC64Bs6XUQDQ%2BPZ3%2Be88XRkhXUF3yAP3GXivXn9m4x%2Fr49DpoOGhRILxN6AHCYGpmZgQqH2u8Kg%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1622518389570")
      )
      .pause(1)
      .exec(http("request_92")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FEpfSocsoPayReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._51b7mc&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=113036")
      )
      .pause(3)
      ...
      .exec(http("request_96")
        ...
        .formParam("CustomSearchParameters[0][Name]", "ReportType")
        .formParam("CustomSearchParameters[0][Value]", "C")
        ...
        .formParam("ReportObjectTypeName", "Reports.Payroll.EpfSocsoPayReport"))
      ...
      .exec(http("request_98")
        ...
        .formParam("arg", "%7B%22reportId%22%3A%2217c6b6344fbd4b56b85f93aa5e4daebe%22%2C%22reportUrl%22%3A%22%22%2C%22drillDownKeys%22%3A%5B%5D%2C%22sortingState%22%3A%5B%5D%2C%22timeZoneOffset%22%3A480%2C%22parameters%22%3A%5B%5D%7D"))
      .pause(401.milliseconds)
      .exec(http("request_99")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBuildStatus")
        .formParam("arg", "%7B%22documentId%22%3A%2278dfdb7c40144d209e33f9112bc9e810%22%2C%22timeOut%22%3A120000%7D"))
      ...
      .exec(http("request_101")
        ...
        .formParam("arg", "78dfdb7c40144d209e33f9112bc9e810"))

      .exec(http("request_103")
        .post("/Report/DXXRDV.axd")

        .formParam("actionKey", "getBrickMap")
        .formParam("arg", "%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%2278dfdb7c40144d209e33f9112bc9e810%22%7D"))
      /*		.exec(http("request_104")
            .get("/Report/DXXRDV.axd?actionKey=getPage&unifier=73995dfd-b090-5309-ec8b-1f1af34130ab&arg=%7B%22pageIndex%22%3A0%2C%22documentId%22%3A%2278dfdb7c40144d209e33f9112bc9e810%22%2C%22resolution%22%3A33%7D")
            )*/
      .pause(13)
  }
