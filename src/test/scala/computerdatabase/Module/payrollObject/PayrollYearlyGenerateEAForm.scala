...
object PayrollYearlyGenerateEAForm {
  ...
  def loadApplication = {
    ...
    exec(http("Borang Generate EA Report")
      .get("/Report/BorangEAReport")
      ...
      .exec(http("request_78")
        .post("/BorangEAReport/CheckBoxListDisplay")
      ...
      .exec(http("request_80")
        .post("/BorangEAReport/ComboBoxDisplay")
      ...
      .exec(http("request_83")
        ...
        .formParam("objectLabel", "LabelDesc_Language")
      ...
      .exec(http("request_86")
        .get("/signalr/negotiate?clientProtocol=2.1&userid=KM00023&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1624249610643")
      )
      ...
      .exec(http("request_88")
        .get("/signalr/start?transport=webSockets&clientProtocol=2.1&userid=KM00023&connectionToken=nVcYWE0TWLiF1H5ct%2FxINonsIestNtxs8qTBjgJaWVvS6VP6wPIkIG2bUhPAPnKs0KsQBCn0rznQpktcLOMd9vKjwzPpkAO%2FAxIw1oXQdG%2FpmU%2BjEZhFMQqjzZyzxy6kKQ4HwZGKEmwyZEkn9LoQjxnmzYRq%2BHUqHxPZipm4jzU%3D&connectionData=%5B%7B%22name%22%3A%22notificationhub%22%7D%5D&_=1624249610644")
      )
      .pause(971.milliseconds)
      .exec(http("request_89")
        .get(uri1 + "/AuthenticationService.Authenticate?1shttps%3A%2F%2Forisoftst.orisoftsaas.com%2FReport%2FBorangEAReport&4sAIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&callback=_xdc_._g7hrvo&key=AIzaSyDu3r6sgbYDPJTjUH9Dun7RSWAyB5aQi8A&token=4762")
      )
      .pause(1)
      ...
      .exec(http("request_97")
        .post("/BorangEAReport/OrganizationUnitsDisplay")
      ...
      .exec(http("request_99")
        .post("/Report/PublishBorangEAProcess")

        .formParam("strJSONCriteriaOption", """{"EmployerAgencyTAX":"16","PayrollYear":"2021","EmployeeStatusWithoutResignee":["A","I"],"PublishDate":"2021/06/21","DocumentType":"EA - NA","Location":[],"LevelRanges":[{"Level":"1","LocationIds":["IHH"]}],"Category":[],"Grade":[],"Employee":[],"HireDateFrom":"","HireDateTo":"","TerminationDateFrom":"","TerminationDateTo":"","TaxArea":[],"PublishRemarks":"","Language":"1","PrintDate":"2021/06/21","StartSerialNo":"1"}""")
        .formParam("ProcessType", "BorangEA"))
      .pause(1)
      .exec(http("request_100")
        .post("/Account/VerifyAccess")
      )
      .exec(http("request_101")
        .post("/Report/DownloadBorangEAReport")
        ...
        .formParam("CustomSearchParameters[16][Name]", "Language")
        .formParam("CustomSearchParameters[16][Value]", "1")
        .formParam("CustomSearchParameters[17][Name]", "PrintDate")
        .formParam("CustomSearchParameters[17][Value]", "2021/06/21")
        .formParam("CustomSearchParameters[18][Name]", "StartSerialNo")
        .formParam("CustomSearchParameters[18][Value]", "1")
        .formParam("ReportObjectTypeName", "Reports.Statutory.BorangEAReport"))
      /*		.exec(http("Download Part Here")
            .get("""/Report/Download?filename=C:\inetpub\wwwroot\UnifyPantai\Content\Uploads\TempDownloads\6e6aaeed-743a-4850-99ea-8bc957211c66\BorangEAReport.pdf""")
            )*/
      .pause(5)
