...
object LeaveBringForward {
  ...
  def processMonitoring = {
    exec(http("request_0")
      ...
      .exec(http("request_23")
        ...
        .formParam("gvCriteriaProcessJobView$DXFREditorcol2", "LVEPRC0001")
  ...
  def logout = {
    exec(http("Submit Logout")
      ...
      .check(status.is(302)))
      .exec(http("Load Login Page after Logout")
        .get("/Account/Login")
      )
