...
object ESSEMPApplyLeave {
  ...
  def loadLeaveForm = {
      exec(http("Load Leave")
        ...
        .check(regex("""var LeaveType = \[(?s).(.*?)\}""").saveAs("leave"))
      ...
      .exec(session => {
        ...
        val leave = session("leave").as[String]
        var arrayValue = Seq[String]()
        val newString = (leave.replaceAll("\\s|\\{", "")).split(",")
        ...
        println(s"data : $submittedAt")

        for(value <- newString){
          val extracted_value = (value.split(":")(1)).replace("'","")
          arrayValue :+= extracted_value
          //println(extracted_value)
        }
        //arrayIds.toArray
        println(arrayValue)

        session.set("curDate",submittedAt).set("paramValue",arrayValue)
      })
  ...
  def saveLeaveDraft = {
    exec(http("request_65")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfLeaveCode", "${paramValue(0)}")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfActualLeaveDate", "${curDate} 00:00:00")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfWorkflowApproverEnable", "no")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfEmpBirthDate", "25/01/2021")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$rfvRequestorEx_ClientState", "")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$selLeaveType", "${paramValue(0)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfLeaveType", "${paramValue(2)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfLeaveUnit", "N")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfHoursPerDay", "${paramValue(4)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfAttachmentFlag", "0")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfApplicationStartDate", "${paramValue(8)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfLeavePeriod", "${paramValue(13)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfApplicationMethod", "${paramValue(9)}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfRequiredApproverRemarks", "${paramValue(18)}")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfEmergencyQty", "${paramValue(11)}")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfBalanceMethod", "${paramValue(10)}")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$txtStartDate", "${curDate}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfStartDate", "${curDate}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$rfvStartDateEx_ClientState", "")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$txtEndDate", "${curDate}")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfEndDate", "${curDate}")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$txtRmks", "TEst")
      ...
      .exec(http("request_74")
        .get("/WebResource.axd?d=G7AEkw1asyYfSFk2Li5D0JhwAppflyxkpGSQDQbA3YX7Us59q1SeSvJlGoBadgH42WWogzokgjSTil628NjzJ-ho-6akTSnjNL_1W4rKMdV6J4E7SFdllL-EXlbUGTEk-wfRgTKBSFluXwws9OgQSz64mOsqxEoa9Z9MfmluHcdALHev8eL9dk6DjmuJdzHl0&t=637529727640000000")
      )
      .exec(http("request_75")
        .get("/DXR.axd?r=1_303,1_184,1_297,1_210,1_220,1_187,1_181,1_289,1_287-P3Vxm")
      )
      .exec(http("request_76")
      ...
      .exec(http("request_82")
        .get("/Notifications/ViewNotifications?type=TbhZX4Bw/cEsXoar9vduxfKIi1MkxdvDazgOMKTWpFGi+ZNUziIGkBRM985m9IQgiGDF2XE3NsW3Ny7TCF4IbgAAWa6w14vkuBGYO02DqTG2WtObeK6sxYmqucKUGkTXFbu9GgI1MftVvPRHk3x8lHAzkDFzrcZ6DCQ6vm7zNLw=")
      )
      .exec(http("request_83")
        .post("/request/get_leave_days.ashx")

        .formParam("StoreAsHr", "N")
        .formParam("EmployeeID", "7036")
        .formParam("EmployeeNo", "00050")
        .formParam("ReferID", "")
        .formParam("LeaveCode", "U1ANL")
        .formParam("LeaveType", "F")
        .formParam("StartDate", "18/07/2021 00:00")
        .formParam("EndDate", "18/07/2021 00:00"))
      ...
      .exec(http("request_103")
        .get("/Notifications/ViewNotifications?type=BTAa4KeefLepJC2vD8Yub4OzMMpXoBRQBRZCpvQKhCn34g6NLjn+ZYToI0RLSL6ZntLwhDNzdVoFCjGGG4W6RNO9ZLuJ5wuRMNW+Nf1N72vpynroOi59wcVZUFXH9diKl0ShJFj2KFR3GRtPfPtEYgxsh0yEY30gSPOU2ePMjvA=")
      )
  ...
  def submitLeave = {
    exec(http("Submit Leave")
      ...
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$hfTSProjectCode", "")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$txtWFApprover", "")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$cntPlcHldrContent$txtRmks", "SCript")
      .formParam("ctl00$ctl00$ctl00$cntPlcHldrContent$cntPlcHldrContent$popupControlState", "{&quot;windowsState&quot;:&quot;0:0:-1:0:0:0:-10000:-10000:1:0:0:0&quot;}")
      .formParam("DXScript", "1_303,1_184,1_297,1_210,1_220,1_187,1_181,1_289,1_287")
      .formParam("DXCss", "0_2312,1_50,1_53,1_51,0_2317,../Content/jquery.jscrollpane.css,../Content/ESS/bootstrap.css,../Content/ESS/NewUIStyle.css,../Content/ESS/ResponsiveSite.css,../Content/generic.light.custom.css,../Content/ESS/font-style.css,https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css,../Content/jquery.orgchart.css,../Content/ESS/style.css,../Content/ESS/component.css,../Content/ESS/alert.css,../Content/ESS/custom/jquery-ui-1.10.3.custom.min.css,../Content/jquery.mmenu.css,../Content/notifications.css,http://unifyhrstc.orisoftsaas.com/Content/ESS/jquery.ui.timepicker.css,/WebResource.axd?d=G7AEkw1asyYfSFk2Li5D0JhwAppflyxkpGSQDQbA3YX7Us59q1SeSvJlGoBadgH42WWogzokgjSTil628NjzJ-ho-6akTSnjNL_1W4rKMdV6J4E7SFdllL-EXlbUGTEk-wfRgTKBSFluXwws9OgQSz64mOsqxEoa9Z9MfmluHcdALHev8eL9dk6DjmuJdzHl0&t=637486420730234278")
      .check(regex("""<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="(.+?)" />""").saveAs("viewStateLogout"))
